                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane in active AvenirLTStd55Roman_5173 house-type-tab" id="villa-view">
                            ...
                            <div class="row mt-5 mb-5">
                                ...
                                if (isset($_GET['a'])) {
                                    $a = $_GET['a'];
                                    $sql = "SELECT * FROM `project` WHERE `project_status`='2' AND `project_type`='1' AND `address_line_2`='$a'";
                                }
                                else{
                                ...
                                if ($completedArray->num_rows > 0) {
                                    while ($completed = $completedArray->fetch_assoc()) { 
                                        ...
                                        // $location_link_2 = ($completed['location_link'] == '') ? '' :  $completed['location_link'];
                        ...
                        <div role="tabpanel" class="tab-pane fade AvenirLTStd55Roman_5173 house-type-tab" id="plot-view">
                            ...
                            <div class="row mt-5 mb-5">
                                ...
                                if (isset($_GET['a'])) {
                                    $a = $_GET['a'];
                                    $sql = "SELECT * FROM `project` WHERE `project_status`='2' AND `project_type`='2' AND `address_line_2`='$a'";
                                }
                                else{
