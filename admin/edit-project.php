                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input  value="<?php echo $row['pdf_link'];?>" type="text" name="pdfLink" class="form-control" 
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input  value="<?php echo $row['address_line_1'];?>" type="text" name="addressLine1"
                                                                    class="form-control" 
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input  value="<?php echo $row['address_line_2'];?>" type="text" name="addressLine2"
                                                                    class="form-control" 
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                        <input  value="<?php echo $row['pin_code'];?>" type="text" class="form-control"  name="pinCode"
